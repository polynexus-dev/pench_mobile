...
//                 // const url = `http://${domain_name}:8888/api/erp/orders/driver/${route_id}/start-trip/`;        /// local testing
...
//                 // const url = `http://${domain_name}:8888/api/erp/orders/driver/${route_id}/complete-trip/`;      /// local testing
...
// //                 const url = route_id
// //                     ? `http://${domain_name}:8888/api/erp/orders/driver/${route_id}/start-trip/` ///local
// //                     : `http://${domain_name}:8888/api/erp/orders/driver/start-tracking/`;
// //                     // ? `https://${domain_name}/api/erp/orders/driver/${route_id}/start-trip/`
// //                     // : `https://${domain_name}/api/erp/orders/driver/start-tracking/`;
...
// //                 const url = route_id
// //                     ? `http://${domain_name}:8888/api/erp/orders/driver/${route_id}/complete-trip/`   //local
// //                     : `http://${domain_name}:8888/api/erp/orders/driver/stop-tracking/`;    //// local
// //                     // ? `https://${domain_name}/api/erp/orders/driver/${route_id}/complete-trip/`
// //                     // : `https://${domain_name}/api/erp/orders/driver/stop-tracking/`;
