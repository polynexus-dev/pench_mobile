...
//   const { route, nearStopId, activeStopId, setActiveStopId } = useGeofenceStore(
//     (s) => ({
//       route: s.route,
//       nearStopId: s.nearStopId,
//       activeStopId: s.activeStopId,
//       setActiveStopId: s.setActiveStopId,
//     })
//   );
...
// } from "react-native-safe-area-context";
// import OSMMap, { OSMMapHandle } from "../components/OSMMap";
// import { useMapTripActions } from "../hooks/useMapTripActions";
...
//   const { isTripStarted, loading: trackingLoading, handleTripToggle } =
//     useMapTripActions();
  ...
  return (
    <>
      ...
      <SafeAreaView edges={["top"]} className="flex-1 bg-black">
        ...
        >
          <BottomSheetScrollView
            key={`${routeStops.length}-${route?.id ?? "route"}`}
            ref={scrollViewRef}
            contentContainerStyle={{
              padding: 15,
              paddingBottom: 110 + insets.bottom,
