...
export default function MapScreen() {
  ...
  const handleMarkDelivered = () => {
    ...
    // console.log("selected stop id in mark delivered", route.id)
...
//   const canMark = useGeofenceStore((s) => s.canMarkActiveStopDelivered());
//    const startGeofenceTracking = useGeofenceStore((s) => s.startGeofenceTracking);
//    const stopGeofenceTracking = useGeofenceStore((s) => s.stopGeofenceTracking);

//   const [selectedStopId, setSelectedStopId] = useState<string | null>(null);
//   const [selectedGroupKey, setSelectedGroupKey] = useState<string | null>(null);
//   const [expandedGroupKey, setExpandedGroupKey] = useState<string | null>(null);

//   const { data: myRoute } = useFetchMyRoute();

//   useEffect(() => {
//     if (myRoute) {
//       setRoute(myRoute as any);
//     }
//   }, [myRoute, setRoute]);
...
//   const handleTripToggle = async () => {
//     const { accessToken } = useAuthStore.getState();
//     const { isTripStarted, startTrip, stopTrip, loading } =
//       useTrackingStore.getState();
...
//                     {activeGroup.stops.length > 1 ? "s" : ""} at the same location
//                   </Text>
//                 </View>
