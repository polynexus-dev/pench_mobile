...
export function DriverDashboardScreen() {
    ...
    if (__DEV__) console.log("route data in dashboard", data);
...
//                                 color="#1B5E37"
//                             />
//                             <QuickAction icon="cube-outline" label="Bottles" onPress={() => { }} color="#1B5E37" />
//                             <QuickAction
//                                 icon="alert-circle-outline"
//                                 label="Report"
//                                 onPress={() => { }}
//                                 color="#D4872A"
//                             />
//                             <QuickAction icon="cash-outline" label="Cash" onPress={() => { }} color="#2E7D32" />
//                             <QuickAction
//                                 icon="checkmark-done-outline"
//                                 label="Attendance"
//                                 onPress={() => { }}
