  ...
  const handleMarkDelivered = () => {
    ...
    router.push({
      ...
      params: {
        ...
        customerName: activeStop.customer_name || "Unknown",
          ...
          <View className={screenX}>
            <View className="flex-row items-center justify-between pb-2">
              ...
              <View className="flex-row items-center gap-x-3">
                <View
                  className={`flex-row items-center gap-x-1.5 rounded-badge border px-3 py-1.5 ${
                    isTripStarted
              ...
              <View className="mt-4 rounded-card bg-brand-primary p-card-y px-card-x shadow-md shadow-brand/40">
                ...
                <View className="mt-2 flex-row justify-between">
                  <Text variant="caption" color="inverse" weight="medium">
                    {route?.stops?.filter((s) => s.order_status === "delivered")
                      .length ?? 0}{" "}
                    done
                  </Text>
                  <Text variant="caption" color="inverse" weight="medium">
              ...
              {displayStop ? (
                <View className="rounded-card border border-border-default bg-bg-card p-card-y px-card-x shadow-sm">
                  ...
                  <View className="mt-5">
                    <Button
                      label={
                        canMark ? "Mark Delivered" : "Move Closer to Enable"
                      }
                      intent="primary"
                      size="lg"
                      fullWidth
