...
Minimal fix
If you want to keep the current structure, your component is already fine; the permission prompt will appear through startTracking() automatically . The main improvement is to rename the alert action or open app settings properly instead of calling enableNetworkProviderAsync() .
